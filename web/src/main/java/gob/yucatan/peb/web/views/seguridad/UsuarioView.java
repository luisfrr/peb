package gob.yucatan.peb.web.views.seguridad;

import gob.yucatan.peb.security.annotations.ConfigPermiso;
...
import gob.yucatan.peb.security.service.iface.IRolService;
import gob.yucatan.peb.security.service.iface.IUsuarioPermisoService;
...
import gob.yucatan.peb.web.views.beans.UserSessionBean;
...
@Slf4j
@ConfigPermiso(tipo = TipoPermiso.CONTROLADOR, codigo = "SEGURIDAD_USUARIOS_VIEW",
...
//    private final IEma emailService;
...
//        }
        ...
        this.rolList = rolService.findAllDynamic(Rol.builder()
...
//        this.usuarioFilter.setEstatus(EstatusUsuario.ACTIVO);
    ...
    @ConfigPermiso(tipo = TipoPermiso.ESCRITURA, codigo = "SEGURIDAD_USUARIOS_WRITE_NUEVO",
    ...
    @ConfigPermiso(tipo = TipoPermiso.ESCRITURA, codigo = "SEGURIDAD_USUARIOS_WRITE_EDITAR",
...
//                    emailService.sendActivateAccountEmail(usuarioCreated);
    ...
    @ConfigPermiso(tipo = TipoPermiso.ESCRITURA, codigo = "SEGURIDAD_USUARIOS_WRITE_ELIMINAR",
    ...
    @ConfigPermiso(tipo = TipoPermiso.ESCRITURA, codigo = "SEGURIDAD_USUARIOS_WRITE_RESTABLECER_CONTRASENIA",
    ...
    public void restablecerContrasenia(Integer idUsuario) {
...
//            emailService.sendResetPasswordEmail(usuario);
    ...
    @ConfigPermiso(tipo = TipoPermiso.ESCRITURA, codigo = "SEGURIDAD_USUARIOS_WRITE_HABILITAR_CUENTA",
    ...
    public void habilitar(Integer idUsuario) {
    ...
    @ConfigPermiso(tipo = TipoPermiso.ESCRITURA, codigo = "SEGURIDAD_USUARIOS_WRITE_DESHABILITAR_CUENTA",
    ...
    @ConfigPermiso(tipo = TipoPermiso.LECTURA, codigo = "SEGURIDAD_USUARIOS_READ_CONFIGURAR_PERMISOS",
...
//                .toList();
    ...
    @ConfigPermiso(tipo = TipoPermiso.ESCRITURA, codigo = "SEGURIDAD_USUARIOS_WRITE_ASIGNAR_PERMISOS",
